...
#define SIMCONNECT_TYPEDEF(type, new_type) typedef type new_type;
...
{
    SIMCONNECT_STRING(Ident, 9);    // ICAO of the object
...
SIMCONNECT_REFSTRUCT SIMCONNECT_ENUMERATE_SIMOBJECT_LIVERY
{
    SIMCONNECT_STRING(AircraftTitle, 256);
    SIMCONNECT_STRING(LiveryName, 256);
};

SIMCONNECT_REFSTRUCT SIMCONNECT_RECV_ENUMERATE_SIMOBJECT_AND_LIVERY_LIST : public SIMCONNECT_RECV_LIST_TEMPLATE
{
...
SIMCONNECTAPI SimConnect_AICreateParkedATCAircraft_EX1(HANDLE hSimConnect, const char * szContainerTitle, const char * szLivery, const char * szTailNumber, const char * szAirportID, SIMCONNECT_DATA_REQUEST_ID RequestID);
SIMCONNECTAPI SimConnect_AICreateEnrouteATCAircraft_EX1(HANDLE hSimConnect, const char * szContainerTitle, const char * szLivery, const char * szTailNumber, int iFlightNumber, const char * szFlightPlanPath, double dFlightPlanPosition, BOOL bTouchAndGo, SIMCONNECT_DATA_REQUEST_ID RequestID);
SIMCONNECTAPI SimConnect_AICreateNonATCAircraft_EX1(HANDLE hSimConnect, const char * szContainerTitle, const char * szLivery, const char * szTailNumber, SIMCONNECT_DATA_INITPOSITION InitPos, SIMCONNECT_DATA_REQUEST_ID RequestID);
SIMCONNECTAPI SimConnect_AICreateSimulatedObject_EX1(HANDLE hSimConnect, const char * szContainerTitle, const char * szLivery, SIMCONNECT_DATA_INITPOSITION InitPos, SIMCONNECT_DATA_REQUEST_ID RequestID);
SIMCONNECTAPI SimConnect_EnumerateSimObjectsAndLiveries(HANDLE hSimConnect, SIMCONNECT_DATA_REQUEST_ID RequestID, SIMCONNECT_SIMOBJECT_TYPE Type);
